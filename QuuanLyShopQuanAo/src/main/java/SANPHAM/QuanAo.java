...
public class QuanAo extends SanPham {
    ...
    public QuanAo(String maSanPham, String tenSanPham, double giaNhap, String ngaySanXuat, int soLuong, String chatLieu, String moTa, boolean trangThai, String mauSac, String sizeQA, String gioiTinh, String kieuDang) {
